...
impl<U: UsbCore> TestClass<U> {
    ...
    pub fn new() -> TestClass<U> {
        TestClass {
            ...
            ep_bulk_in: EndpointConfig::bulk(64).into(),
            ep_bulk_out: EndpointConfig::bulk(64).into(),
            ep_interrupt_in: EndpointConfig::interrupt(31, 1).into(),
            ep_interrupt_out: EndpointConfig::interrupt(31, 1).into(),
            control_buf: [0; 256],
            bulk_buf: [0; 256],
            interrupt_buf: [0; 256],
            len: 0,
